...
class View extends JFrame implements Observer {
	...
	private final float dmC = (float) 1.95;
	...
	View() {
		...
		bfPanel.setBorder(new TitledBorder("Belg. Franc"));
	...
	public void update(Observable obs, Object obj) {
		...
		dmText.setText("" + (getEuros() * dmC));
		bfText.setText("" + (getEuros() * bfC));
		ffText.setText("" + (getEuros() * ffC));
		ilText.setText("" + (getEuros() * ilC));
