...
public class TiroModelo {
	...
	public TiroModelo(int ancho, int alto, int diametro){
		...
		setAlto(alto);
		setAncho(ancho);
		x0 = ancho/2;			//Mitad del panel
		y0 = alto - diametro/2 -10;		//Parte inferior del panel
		xRebote = x0;
		yRebote = y0;
	...
	public void next(){
		...
		x = (int) (vx0 * tiempo + xRebote - diametro/2);
		y =  (int) (vy0 * tiempo + yRebote - diametro/2);
	...
	public void reset(){
		tiempo = 0;
		this.tiro = this.centro;
		this.colorTiro = this.colorCentro;
		this.xRebote = this.x0;
		this.yRebote = this.y0;
	}
	...
	public void cambiaAngulo(){
		...
		setVy0(velocidadInicial * Math.sin(Math.toRadians(angulo)));
		setVx0(velocidadInicial * Math.cos(Math.toRadians(angulo)));
		setxRebote(x + diametro / 2);
		setyRebote(y + diametro / 2);
		setTiempo(0);
	 ...
	 * @return the yRebote
	 */
	public double getyRebote() {
		return yRebote;
	}

	/**
	 * @param yRebote the yRebote to set
	 */
	public void setyRebote(double yRebote) {
		this.yRebote = yRebote;
	}

	/**
	 * @return the xRebote
	 */
	public double getxRebote() {
		return xRebote;
	}

	/**
	 * @param xRebote the xRebote to set
	 */
	public void setxRebote(double xRebote) {
		this.xRebote = xRebote;
	}
