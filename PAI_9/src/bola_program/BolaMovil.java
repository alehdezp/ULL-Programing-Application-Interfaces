...
public class BolaMovil extends JFrame{
	...
	public BolaMovil(String[] factor) {
		...
		if (factor.length == 1){//Mientras se le pase un parametro
			...
			tm = new Timer(1000, new Randomize());
		    tm.start();
	...
	class Randomize implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			int i = rn.nextInt()%8;
			switch(i){
			case 0: getPanelBola().getBolaAzul().moveNO();break;
			case 1: getPanelBola().getBolaAzul().moveNE();break;
			case 2: getPanelBola().getBolaAzul().moveUp();break;
			case 3: getPanelBola().getBolaAzul().moveLeft();break;
			case 4: getPanelBola().getBolaAzul().moveRight();break;
			case 5: getPanelBola().getBolaAzul().moveSO();break;
			case 6: getPanelBola().getBolaAzul().moveSE();break;
			case 7: getPanelBola().getBolaAzul().moveDown();break;
			default:;
			}
			i = rn.nextInt()%8;
			switch(i){
			case 0: getPanelBola().getBolaRoja().moveNO();break;
			case 1: getPanelBola().getBolaRoja().moveNE();break;
			case 2: getPanelBola().getBolaRoja().moveUp();break;
			case 3: getPanelBola().getBolaRoja().moveLeft();break;
			case 4: getPanelBola().getBolaRoja().moveRight();break;
			case 5: getPanelBola().getBolaRoja().moveSO();break;
			case 6: getPanelBola().getBolaRoja().moveSE();break;
			case 7: getPanelBola().getBolaRoja().moveDown();break;
			default:;
			}
			getPanelBola().repaint();
